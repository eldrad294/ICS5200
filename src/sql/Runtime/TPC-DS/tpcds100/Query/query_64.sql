WITH cs_ui
     AS (SELECT cs_item_sk,
         ...
         WHERE  cs_item_sk = cr_item_sk
         		and cr_item_sk between 2371 and 4000
         		and cs_item_sk between 100000 and 110000
         		and cs_order_number between 853 and 1500
     ...
     AS (SELECT i_product_name         product_name,
         ...
         WHERE  ss_store_sk = s_store_sk
                ...
                AND i_color IN ( 'blush', 'slate', 'cream', 'green',
                                 'frosted', 'deep' )
                AND i_current_price BETWEEN 73 AND 73 + 10
                AND i_current_price BETWEEN 73 + 1 AND 73 + 15
                and rownum <= 10000
