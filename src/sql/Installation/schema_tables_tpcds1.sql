...
(
    ...
    i_current_price           decimal(15,5)                 ,
    i_wholesale_cost          decimal(15,5)                 ,
    i_brand_id                integer                       ,
    i_brand                   char(50)                      ,
    i_class_id                integer                       ,
    i_class                   char(50)                      ,
...
(
    ...
    sr_return_amt             decimal(15,5)                 ,
    sr_return_tax             decimal(15,5)                 ,
    sr_return_amt_inc_tax     decimal(15,5)                 ,
    sr_fee                    decimal(15,5)                 ,
    sr_return_ship_cost       decimal(15,5)                 ,
    sr_refunded_cash          decimal(15,5)                 ,
    sr_reversed_charge        decimal(15,5)                 ,
...
(
    ...
    cr_return_amount          decimal(15,5)                 ,
    cr_return_tax             decimal(15,5)                 ,
    cr_return_amt_inc_tax     decimal(15,5)                 ,
    cr_fee                    decimal(15,5)                 ,
    cr_return_ship_cost       decimal(15,5)                 ,
    cr_refunded_cash          decimal(15,5)                 ,
    cr_reversed_charge        decimal(15,5)                 ,
...
(
    ...
    wr_return_amt             decimal(15,5)                 ,
    wr_return_tax             decimal(15,5)                 ,
    wr_return_amt_inc_tax     decimal(15,5)                 ,
    wr_fee                    decimal(15,5)                 ,
    wr_return_ship_cost       decimal(15,5)                 ,
    wr_refunded_cash          decimal(15,5)                 ,
    wr_reversed_charge        decimal(15,5)                 ,
...
(
    ...
    ws_quantity               integer                       ,
    ws_wholesale_cost         decimal(15,5)                 ,
    ws_list_price             decimal(15,5)                 ,
    ws_sales_price            decimal(15,5)                 ,
    ws_ext_discount_amt       decimal(15,5)                 ,
    ws_ext_sales_price        decimal(15,5)                 ,
    ws_ext_wholesale_cost     decimal(15,5)                 ,
    ws_ext_list_price         decimal(15,5)                 ,
    ws_ext_tax                decimal(15,5)                 ,
    ws_coupon_amt             decimal(15,5)                 ,
    ws_ext_ship_cost          decimal(15,5)                 ,
    ws_net_paid               decimal(15,5)                 ,
    ws_net_paid_inc_tax       decimal(15,5)                 ,
    ws_net_paid_inc_ship      decimal(15,5)                 ,
...
(
    ...
    cs_quantity               integer                       ,
    cs_wholesale_cost         decimal(15,5)                 ,
    cs_list_price             decimal(15,5)                 ,
    cs_sales_price            decimal(15,5)                 ,
    cs_ext_discount_amt       decimal(15,5)                 ,
    cs_ext_sales_price        decimal(15,5)                 ,
    cs_ext_wholesale_cost     decimal(15,5)                 ,
    cs_ext_list_price         decimal(15,5)                 ,
    cs_ext_tax                decimal(15,5)                 ,
    cs_coupon_amt             decimal(15,5)                 ,
    cs_ext_ship_cost          decimal(15,5)                 ,
    cs_net_paid               decimal(15,5)                 ,
    cs_net_paid_inc_tax       decimal(15,5)                 ,
    cs_net_paid_inc_ship      decimal(15,5)                 ,
...
(
    ...
    ss_quantity               integer                       ,
    ss_wholesale_cost         decimal(15,5)                 ,
    ss_list_price             decimal(15,5)                 ,
    ss_sales_price            decimal(15,5)                 ,
    ss_ext_discount_amt       decimal(15,5)                 ,
    ss_ext_sales_price        decimal(15,5)                 ,
    ss_ext_wholesale_cost     decimal(15,5)                 ,
    ss_ext_list_price         decimal(15,5)                 ,
    ss_ext_tax                decimal(15,5)                 ,
    ss_coupon_amt             decimal(15,5)                 ,
    ss_net_paid               decimal(15,5)                 ,
...
CREATE TABLE REP_TPC_DESCRIBE (
    ...
    row_count number,
    index_count number) tablespace tpcds1 nologging;
...
tablespace tpcds1 nologging;
create table REP_EXECUTION_PLANS tablespace tpcds1 nologging as select * from v$sql where 1=0;
...
create table REP_HIST_SNAPSHOT tablespace tpcds1 nologging as
    select dhsql.*,
           dhsnap.startup_time,
...
create table REP_VSQL_PLAN tablespace tpcds1 nologging as
    ...
    from v$sql_plan
    where 1=0;
create table REP_HIST_SYSMETRIC_SUMMARY tablespace tpcds1 nologging as
    select dhss.*,
           dhsnap.startup_time,
           dhsnap.flush_elapsed,
           dhsnap.snap_level,
    ...
    and 1=0;
create table REP_HIST_SYSSTAT tablespace tpcds1 nologging as
    select dhsys.*,
           dhs.startup_time,
