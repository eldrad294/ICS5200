...
CREATE TABLE REP_TPC_DESCRIBE (
    ...
    row_count number,
    index_count number) tablespace tpcds100 nologging;
...
tablespace tpcds100 nologging;
create table REP_EXECUTION_PLANS tablespace tpcds100 nologging as select * from v$sql where 1=0;
...
create table REP_HIST_SNAPSHOT tablespace tpcds100 nologging as
    select dhsql.*,
           dhsnap.startup_time,
    ...
    and 1=0;
create table REP_VSQL_PLAN tablespace tpcds100 nologging as
    select *
    from v$sql_plan
    and 1=0;
